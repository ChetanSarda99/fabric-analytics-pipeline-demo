# Microsoft Fabric Analytics Pipeline (Local Equivalent)
...
Why Polars over pandas here: Polars is faster, supports lazy evaluation (so the query planner can push filters and projections down before materializing), and has native Delta Lake write support. On a 150-row project it doesn't matter; the habit matters.
